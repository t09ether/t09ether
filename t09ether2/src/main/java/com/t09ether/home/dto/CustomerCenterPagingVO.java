...
public class CustomerCenterPagingVO {
	//페이징에 필요한 변수들
		private int nowPage = 1; //현재 페이지
		private int onePageRecord = 7; // 한 페이지에 표시할 레코드 수
		private int totalRecord; //총 레코드 수
		private int totalPage; //총 페이지 수
		private int lastPageRecord; //마지막 페이지에 남아 있는 레코드 수
		
		private int onePageNumCount=5;//한 페이지당 페이지 갯수
		...
		public void setTotalRecord(int totalRecord) {
			...
			//총 레코드 수를 이용하여 총 페이지 수를 구하기 여기서 페이지 계산함
